...
class BookServiceTest @Autowired constructor(
    ...
    @AfterEach
    fun clean(){
       bookRepository.deleteAll()  // deleteAll 자식테이블까지 모두 찾아서 제거해줌
    ...
    fun loanBookTest(){
        ...
        val savedUser = userRepository.save(User("김슬기", null))
        val request = BookLoanRequest("김슬기", "이상한 나라의 앨리스")
    ...
    fun returnBookTest(){
        ...
        val savedUser = userRepository.save(User("김슬기", null))
        userLoanHistoryRepository.save(UserLoanHistory.fixture(savedUser, "이상한 나라의 앨리스"))
        val request = BookReturnRequest("김슬기", "이상한 나라의 앨리스")
    ...
    fun countLoanedBookTest(){
        ...
        userLoanHistoryRepository.saveAll(listOf(
            UserLoanHistory.fixture(savedUser, "A"),  // 대출중
            UserLoanHistory.fixture(savedUser, "B", UserLoanStatus.RETURNED), // 반납
            UserLoanHistory.fixture(savedUser, "C", UserLoanStatus.RETURNED)
        ))

        // when
        val result = bookService.countLoanedBook() // 대출중인거 1개만 나와야함
